...
import { CalendarIcon, User, Users, Building, Heart, Brain, Bone, Baby, Layers, Venus, Video, ArrowLeft } from "lucide-react";
  ...
  function onSubmit(data: AppointmentFormValues) {
    ...
    if (isPastAppointment) {
        ...
        newAppointment = {
            ...
            doctorsNotes: notes[randomIndex],
            prescription: prescriptions[randomIndex],
            testReports: reports[randomIndex],
        };
    } else {
        newAppointment = {
            ...data,
